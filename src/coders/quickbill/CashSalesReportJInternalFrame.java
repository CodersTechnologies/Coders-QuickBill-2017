 ...
 * @author sunny
 */
public class CashSalesReportJInternalFrame extends javax.swing.JInternalFrame {
     ...
     */
    public CashSalesReportJInternalFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Select Report From and To Date"));
    ...
    public void getOverAllSales(){
        ...
        try{
            ...
            String sql="Select s_Item as 'Item Name', SUM(s_Qty) s_Qty,"
                    + "SUM(s_CGSTAmt) s_CGSTAmt,SUM(s_SGSTAmt) s_SGSTAmt,SUM(s_IGSTAmt) s_IGSTAmt,"
                    + "SUM(s_Amount) s_Amount from Sales where s_Date BETWEEN '"+FromDT+"' and '"+ToDT+"' "
                    +"GROUP BY s_Item";
    ...
    public void printReport(){
        try{
            String sql="Select Sales.s_Item, Sales.s_Unit, SUM(Sales.s_Qty) s_Qty,"
                    + "SUM(Sales.s_CGSTAmt) s_CGSTAmt,SUM(Sales.s_SGSTAmt) s_SGSTAmt,SUM(Sales.s_IGSTAmt) s_IGSTAmt,"
                    + "SUM(Sales.s_Amount) s_Amount,Company.c_name,Company.c_address,Company.c_contact,Company.c_email,Company.c_gstin from Sales,Company where Sales.s_Date BETWEEN '"+FromDT+"' and '"+ToDT+"' "
                    + "GROUP BY Sales.s_Item";
            JasperDesign jd= JRXmlLoader.load("src/coders/reports/a4SalesReport.jrxml");
