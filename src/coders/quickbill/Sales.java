...
public class Sales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuNewInvoice = new javax.swing.JMenuItem();
        mnuAccounts = new javax.swing.JMenu();
        mnuSettleSalesAccount = new javax.swing.JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Sales - Coders Quickbill 2017");
        setAlwaysOnTop(true);
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtAddress, javax.swing.GroupLayout.DEFAULT_SIZE, 558, Short.MAX_VALUE)))))
                .addContainerGap())
        );
        ...
        lblDate.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnSaveTransaction, btnUpdateTransaction});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnSaveTransaction, btnUpdateTransaction});
        ...
        mnuInvoice.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N

        mnuNewInvoice.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        mnuNewInvoice.setText("New Invoice");
        mnuNewInvoice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuNewInvoiceActionPerformed(evt);
            }
        });
        mnuInvoice.add(mnuNewInvoice);

        jMenuBar1.add(mnuInvoice);

        mnuAccounts.setText("Accounts");
        mnuAccounts.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N

        mnuSettleSalesAccount.setFont(new java.awt.Font("Ubuntu", 0, 13)); // NOI18N
        mnuSettleSalesAccount.setText("Settle Sales Account");
        mnuSettleSalesAccount.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mnuSettleSalesAccountMouseClicked(evt);
            }
        });
        mnuAccounts.add(mnuSettleSalesAccount);
    ...
    */
    ...
    double qty=1,rate,ttl,disc,discAmt,taxval,taxAmt,cgst,cgstPer,csgtAmt,sgst,sgstPer,sgstAmt,igst,igstPer,igstAmt,FinalAmt;
    String item;
    double newQty;
    public void barcodeScan(){
        try{
            ...
            if(rs.next()){
                ...
                btnDelete.setEnabled(false);  
                txtBarcode.requestFocus();
                JOptionPane.showMessageDialog(null, "Product Data not found in Record","Oop's! Record not found",JOptionPane.WARNING_MESSAGE);                
            }
        }
        catch(SQLException e){
    ...
    public void loadSelect(){
        try{            
            ...
            txtItem.setText(tblProducts.getValueAt(0, 2).toString());
            txtQty.setText(Double.toString(qty));
            maxqty=Double.parseDouble(tblProducts.getValueAt(0, 4).toString());
            txtUnit.setText(tblProducts.getValueAt(0, 5).toString());
            txtRate.setText(tblProducts.getValueAt(0, 6).toString());
            txtCGSTPer.setText(tblProducts.getValueAt(0, 7).toString());
            txtSGSTPer.setText(tblProducts.getValueAt(0, 8).toString());
            txtIGSTPer.setText(tblProducts.getValueAt(0, 9).toString());
        }
    ...
    double qty1,rate1,tot1,disc1=0,taxVal1,cgstPer1=0,cgstAmt1,sgstPer1=0,sgstAmt1,igstPer1=0,igstAmt1,grossAmt1;
    ...
    public void getCustDataToTblOnCon2(){
        try{
            String KeyVal=txtName.getText();
            String sql="Select * from Customer where cContact2 LIKE ?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,"%"+KeyVal + "%");
            rs=pst.executeQuery();
            tblCustomers.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public void addToBill(){
        try{
            String sql="Insert into Sales(s_InvoiceID,s_CustomerID,s_Barcode,s_Date,s_Item,s_Qty,s_Unit,s_Rate,s_Total,s_Discount,s_TaxableValue,"
                    + "s_CGSTPer,s_CGSTAmt,s_SGSTPer,s_SGSTAmt,s_IGSTPer,s_IGSTAmt,s_Amount)"
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                pst=conn.prepareStatement(sql);
    ...
    private void txtQtyKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtQtyKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            if(Double.parseDouble(txtQty.getText())<=maxqty && !"".equals(txtQty.getText())){
                calcFieldVal();
            }     
            else{
    ...
    private void mnuSettleSalesAccountMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mnuSettleSalesAccountMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_mnuSettleSalesAccountMouseClicked
    ...
    public void updtBillList(){
        try{
            ...
            String sql="update Sales set s_Barcode=?,s_Item=?,s_Qty=?,s_Unit=?,s_Rate=?,s_Total=?,s_Discount=?,s_TaxableValue=?,"
                    + "s_CGSTPer=?,s_CGSTAmt=?,s_SGSTPer=?,s_SGSTAmt=?,s_IGSTPer=?,s_IGSTAmt=?,s_Amount=? where s_count='"+tblClick+"'";
            pst=conn.prepareStatement(sql);
    ...
    public void delBillData(){
        ...
        //Program to data stock from Sales Database
        try{
    ...
    private void mnuNewInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuNewInvoiceActionPerformed
        // TODO add your handling code here:
        resetCustTrans();
        getBillID();
        resetFields();
    }//GEN-LAST:event_mnuNewInvoiceActionPerformed
    ...
    public void printOptions(){
        try{
            ...
            if(x == 0){
                try{
                    String sql="Select * from Transactions,Sales where Sales.s_InvoiceID='"+InvID+"' "
    ...
    private javax.swing.JMenuItem mnuNewInvoice;
    private javax.swing.JMenuItem mnuSettleSalesAccount;
