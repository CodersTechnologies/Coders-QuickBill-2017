...
public class PurchaseInvoice extends javax.swing.JFrame {
    ...
    public void calcPurchaseCost(){
        try{
            ...
            pCGST=(purRate*purCGST)/100;
            pSGST=(purRate*purSGST)/100;
            pIGST=(purRate*purIGST)/100;
            purCost=Math.round(purRate+pCGST+pSGST+pIGST);
            ...
            txtPurTotAmt.setText(String.valueOf(purCost*(Double.parseDouble(txtQty.getText()))));            
        }
    ...
    public void calcSalesCost(){
        try{
            ...
            sCGST=(salesRate*salesCGST)/100;
            sSGST=(salesRate*salesSGST)/100;
            sIGST=(salesRate*salesIGST)/100;
            salesCost=Math.round(salesRate+sCGST+sSGST+sIGST);
            ...
            txtSalesTotAmt.setText(String.valueOf(salesCost*(Double.parseDouble(txtQty.getText()))));            
        }
        catch(NumberFormatException e){
            //JOptionPane.showMessageDialog(null, e,"calcPurchaseCost() Exception",JOptionPane.ERROR_MESSAGE);
        }
